...
const Header:React.FC = () => {
    ...
    return (
        <header className={`transition-colors duration-700 fixed z-50 right-0 left-0 top-0 ${ scrollY > 200 ? "text-black bg-white" : "bg-black/20 text-white" }`}>
            <div className={`w-full bg-black/60  right-0 top-0 h-screen ${ isMenuOpen ? "absolute z-20 w-screen" : "hidden w-0" }`}></div>
            ...
            <div className="max-w-7xl mx-auto p-5">
                <div className="hidden items-center justify-between lg:flex">
                    ...
                    <a className="py-2 px-5 rounded bg-blue-500 font-bold text-white" href="#">
                        Juntar-se a equipe
                    </a>
                </div>
