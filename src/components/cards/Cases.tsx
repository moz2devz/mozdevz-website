...
const Cases:React.FC<CasesProps> = ({ Icon, question, answer }) => {
  return (
      <div className="max-w-xs bg-gray-200 rounded p-5 pt-12 overflow-hidden group cursor-pointer transition-all duration-500 hover:bg-blue-500 hover:text-white hover:-translate-y-6">
